                                ...
                                <tr>
                                    ...
                                    <td class="text-end pe-3">
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('admin.quiz.question.edit', ['quizId' => $quiz->id, 'questionId' => $question->id]) }}"
                                                class="btn btn-warning">
                                                <i class="bi bi-pencil me-1"></i> Edit
                                            </a>
                                            <form
                                                action="{{ route('admin.quiz.question.destroy', ['quizId' => $quiz->id, 'questionId' => $question->id]) }}"
